...
- **access**
  - AccessLevel.PUBLIC : AccessLevel.NONE 접근 제어자 public, 나머지도 같음.
  - AccessLevel.MODULE : AccessLevel.PACKAGE와 동일. default와 같다. 패키지 내에서 접근 가능
...
- 모든 필드에 대해 @ToString, @EqualsAndHashCode, @Getter
- final이 아닌 필드에 대해 @Setter, @RequiredArgsConstructor
